...
const cmd_shell_instance_mod = @import("cmd_shell_instance.zig");
...
pub const cmd_shell_instance = cmd_shell_instance_mod;
...
pub const findDesktopProcessByAppAndPid = process_table_mod.findDesktopProcessByAppAndPid;
...
pub const getProcessPid = process_table_mod.getProcessPid;
pub const getProcessIndex = process_table_mod.getProcessIndex;
...
pub const explorerNavigateToPath = explorer_state_mod.explorerNavigateToPath;
...
// Re-export CMD shell instance functions
pub const createCmdWindow = cmd_shell_instance_mod.createCmdWindow;
pub const destroyCmdWindow = cmd_shell_instance_mod.destroyCmdWindow;
pub const getFocusedCmdIndex = cmd_shell_instance_mod.getFocusedCmdIndex;
pub const setFocusedCmdIndex = cmd_shell_instance_mod.setFocusedCmdIndex;
pub const moveCmdWindow = cmd_shell_instance_mod.moveCmdWindow;
pub const resizeCmdWindow = cmd_shell_instance_mod.resizeCmdWindow;
pub const minimizeCmdWindow = cmd_shell_instance_mod.minimizeCmdWindow;
pub const maximizeCmdWindow = cmd_shell_instance_mod.maximizeCmdWindow;
pub const restoreCmdWindow = cmd_shell_instance_mod.restoreCmdWindow;
pub const updateCmdCaptionHover = cmd_shell_instance_mod.updateCmdCaptionHover;
pub const cmdAppendChar = cmd_shell_instance_mod.cmdAppendChar;
pub const cmdBackspace = cmd_shell_instance_mod.cmdBackspace;
pub const cmdClearInput = cmd_shell_instance_mod.cmdClearInput;
pub const cmdExecuteCommand = cmd_shell_instance_mod.cmdExecuteCommand;
pub const renderAllCmdInstances = cmd_shell_instance_mod.renderAllCmdInstances;
pub const getCmdInstanceCount = cmd_shell_instance_mod.getCmdInstanceCount;
pub const getCmdInstance = cmd_shell_instance_mod.getCmdInstance;
pub const anyCmdWindowVisible = cmd_shell_instance_mod.anyCmdWindowVisible;
pub const hitTestCmdWindow = cmd_shell_instance_mod.hitTestCmdWindow;
pub const hitTestCmdCaption = cmd_shell_instance_mod.hitTestCmdCaption;
pub const hitTestCmdCloseButton = cmd_shell_instance_mod.hitTestCmdCloseButton;
pub const focusCmdWindowAtPosition = cmd_shell_instance_mod.focusCmdWindowAtPosition;
pub const getCmdInstanceAtPosition = cmd_shell_instance_mod.getCmdInstanceAtPosition;
pub const startCmdWindowDrag = cmd_shell_instance_mod.startCmdWindowDrag;
pub const processCmdWindowDrag = cmd_shell_instance_mod.processCmdWindowDrag;
pub const endCmdWindowDrag = cmd_shell_instance_mod.endCmdWindowDrag;
pub const isCmdWindowDragging = cmd_shell_instance_mod.isCmdWindowDragging;
pub const getCmdDragIndex = cmd_shell_instance_mod.getCmdDragIndex;
pub const CmdWindowInstance = cmd_shell_instance_mod.CmdWindowInstance;
pub const CaptionButtonType = cmd_shell_instance_mod.CaptionButtonType;
