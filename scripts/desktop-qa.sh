...
echo "  Matrix: GOP res × display.double_buffer × display.triple_buffer × present_full_flip; grep 'DesktopPointerDiag:' 'FramebufferMem:' 'double_buf='"
echo "  LoongArch regression: zig build kernel -Darch=loongarch64"
